...
import a24seven.uz.databinding.ProductImageBinding
    ...
    inner class ViewHolder(var binding: ProductImageBinding) : RecyclerView.ViewHolder(binding.root) {
        ...
        init {
            itemView.setOnClickListener {
                        StfalconImageViewer.Builder(context,images,::loadPosterImage).withBackgroundColor(
...
//                1000
//            )
            .encodeFormat(Bitmap.CompressFormat.PNG).centerInside()
