...
import a24seven.uz.databinding.FragmentMapBinding
import a24seven.uz.network.models.LocPoint
import a24seven.uz.network.utils.Resource
import a24seven.uz.network.utils.Variables
import a24seven.uz.ui.cart.CartFragmentDirections
import a24seven.uz.ui.profile.myAddresses.AddAddressData
import a24seven.uz.ui.profile.myAddresses.AddressListFragmentDirections
        ...
        binding.btnChooseLocation.setOnClickListener {
            when(safeArgs.fromDestination){
                ...
                val action = CartFragmentDirections.actionNavCartToNavCheckOut(
                    ...
                    Log.d("ollg", safeArgs.checkOutData!!.toString())
                    Log.d("ollg", addresss)
                    Log.d("ollg", region)
                    Log.d("ollg", city)
                    Log.d("ollg", LocPoint(lat, long).toString())
